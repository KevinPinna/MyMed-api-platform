  ...
  return (
    <>
      <div className="flex gap-4">
        ...
        <div className="w-3/5 bg-white border rounded-xl shadow-sm p-4 flex flex-col">
                          ...
                          <td className="px-3 py-2 align-top">
                            ...
                            {isCompleted && reportForAppointment && (
                              <button
                                type="button"
                                onClick={() =>
                                  onOpenPdf?.(reportForAppointment)
                                }
        ...
        <div className="flex-1 bg-white border rounded-xl shadow-sm p-4 flex flex-col">
          {!selectedAppointment ? (
